export default function HomeFeatures() {
  return (
    <section
      id="_features_carousel_slider_v6_001"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-16">
          ...
          >
            ...
            <h2 className="text-slate-900 dark:text-white text-4xl sm:text-5xl font-bold mb-6">
          ...
          <div className="lg:col-span-7 flex flex-col justify-end">
            <p
              data-animate="text"
              className="text-slate-600 dark:text-neutral-400 text-lg mb-6"
              style={{ opacity: 1 }}
            >
              <span
                className="motion-word"
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="w-12 h-12 rounded-full border-2 border-indigo-600 dark:border-indigo-400 flex items-center justify-center text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 dark:hover:bg-indigo-500 hover:text-white dark:hover:text-white transition-all duration-300"
                style={{
                  opacity: 1,
                  transform: "translateY(0px)",
                  filter: "blur(0px)",
        ...
        <div className="overflow-hidden">
          ...
          >
            ...
            >
              <div className="p-8 bg-indigo-50 dark:bg-indigo-900/20 rounded-3xl h-full">
                <div
                  data-motion="icon"
                  className="w-14 h-14 bg-indigo-100 dark:bg-indigo-800/40 rounded-2xl flex items-center justify-center mb-6"
                  style={{
                    opacity: 1,
                    transform: "scale(1)",
                    filter: "blur(0px)",
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-base">
                  Lightning-fast content delivery with 200+ edge locations
                  worldwide for optimal performance.
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-8 bg-slate-50 dark:bg-neutral-900 rounded-3xl h-full">
                <div
                  data-motion="icon"
                  className="w-14 h-14 bg-indigo-100 dark:bg-indigo-900/40 rounded-2xl flex items-center justify-center mb-6"
                  style={{
                    opacity: 1,
                    transform: "scale(1)",
                    filter: "blur(0px)",
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-base">
                  Monitor user behavior and campaign performance with instant
            ...
            >
              <div className="p-8 bg-slate-50 dark:bg-neutral-900 rounded-3xl h-full">
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-base">
                  Automatically handle traffic spikes with intelligent resource
            ...
            >
              <div className="p-8 bg-indigo-600 rounded-3xl h-full">
                <div
                  data-motion="icon"
                ...
                <p className="text-indigo-100 text-base">
                  Enterprise-grade security with SOC 2 compliance, encryption at
                  rest, and advanced threat protection.
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-8 bg-slate-50 dark:bg-neutral-900 rounded-3xl h-full">
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-base">
                  Connect with 500+ apps through our REST API and pre-built
            ...
            >
              <div className="p-8 bg-slate-50 dark:bg-neutral-900 rounded-3xl h-full">
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-base">
                  White-label solution with full customization options for
                  colors, logos, and domain mapping.
                </p>
              </div>
            </div>
          </div>
  ...
  (function() {
    function initCarousel() {
      const section = document.getElementById('_features_carousel_slider_v6_001');
      if (!section) return;
