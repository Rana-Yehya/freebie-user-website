...
//                       data-motion="button"
//                       href="#"
//                       className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-full transition-colors"
//                       style={{
//                         opacity: 1,
//                         transform: "translateY(0px)",
//                         filter: "blur(0px)",
...
//                     >
//                       Shop Collection
//                       {/* <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-darkreader-inline-stroke="" style="--darkreader-inline-stroke: currentColor;">
...
// </h1>
//             <p className="mt-2 sm:mt-8 text-[clamp(0.875rem,2vw,1.125rem)] sm:text-[clamp(1rem,2.5vw,1.25rem)] leading-relaxed max-w-2xl mx-auto">
//           Spread joy in every occasion
//         </p> */}
//               {/* <p
//                 data-animate="text"
//                 className="mt-8 text-xl max-w-lg leading-relaxed"
//                 style={{ opacity: 1 }}
//               >
//                 <span
//                   className="motion-word text-[clamp(0.875rem,2vw,1rem)]
//                   sm:text-[clamp(1rem,2.5vw,1.125rem)]d"
//                   style={{
